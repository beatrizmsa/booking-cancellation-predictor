...
# Function to identify the best hyperparameters for an MLPClassifier (Neural Network)
...
# Function to find the optimal number of neighbors for a KNeighborsClassifier
...
# Function to print feature importances from Decision Tree
...
# Function to print a detailed classification report
...
# Function to generate ROC data for different models
...
# Function to create de plot for the roc curve
